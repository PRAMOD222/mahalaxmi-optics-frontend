    ...
    <div className="container">
      <div className=" px-4 py-8 md:mx-28 ">
        ...
        <div className="space-y-4 w-fit">
          ...
          <p>
            This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011, that require publishing the rules and regulations, privacy policy, and Terms of Use for access or usage of the domain name [Enter_Your_Website_URL] (“Website”), including the related mobile site and mobile application (hereinafter referred to as “Platform”).
          </p>
          <p>
            The Platform is owned by [Enter_Your_Company_Name], a company incorporated under the Companies Act, 1956, with its registered office at [Enter_Company_Address] (hereinafter referred to as quot;Platform Owner, quot;we,quot; quot;us,quot; or quot;ourquot;).
          </p>
          <p>
            Your use of the Platform, services, and tools are governed by the following terms and conditions (quot;Terms of Usequot;) as applicable to the Platform, including the applicable policies which are incorporated herein by way of reference. If you transact on the Platform, you shall be subject to the policies that are applicable for such transactions. By mere use of the Platform, you shall be contracting with the Platform Owner, and these terms and conditions, including the policies, constitute your binding obligations with the Platform Owner.
          </p>
          <p>
          ...
          <p>
            For the purpose of these Terms of Use, wherever the context so requires, quot;youquot;, quot;yourquot;, or quot;userquot; shall mean any natural or legal person who has agreed to become a user/buyer on the Platform.
          </p>
          ...
          <div className="space-y-2">
            ...
            <div >
              ...
              These Terms and any dispute or claim relating to them, or their enforceability, shall be governed by and construed in accordance with the laws of India. All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in North 24 [City, State]
            </div>
            <div >
